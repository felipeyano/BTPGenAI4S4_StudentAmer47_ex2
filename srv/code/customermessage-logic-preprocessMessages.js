 ...
 * @Before(event = { "READ" }, entity = "bTPGenAI4S4_StudentAmer47_ex2Srv.CustomerMessage")
...
try {
    ...
    customerMessages = await SELECT.from('BTPGenAI4S4_StudentAmer47_ex2.CustomerMessage').forUpdate();
} catch (error) {
